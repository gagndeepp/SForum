...
-->
			...
			<form action="/forum/UpdatePostController" method="post">
				...
				<div class="card m-5 shadow-lg text-white bg-info">
					...
					<div class="card-body">
						...
						<h6 class="card-title">Question Desc</h6>
						...
						<p class="card-text">
							...
							<input class="form-control shadow-lg mb-3 bg-white rounded"
								...
								name="postdesc"
								value='${requestScope.currentPost.getPostDesc()}'
						...
						<p class="card-text">
							...
							<input class="form-control shadow-lg mb-3 bg-white rounded"
								style="width: 420px; color: black;" name="currentpostId"
								type="hidden" title="Employee Id"
								value="${requestScope.currentPost.getPostId()}" required>
						...
						<input type=submit value="Execute Update" class="btn btn-danger">
